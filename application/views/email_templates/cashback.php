			...
			<div class="email-tem-inn">
				<div class="email-tem-main">
					<div class="email-tem-head">
						<h2><img src="<?=base_url()?>assets/emaildata/letter3.png" alt=""> Frinza Wallet Cash Back!</h2>
					</div>

					<div class="email-tem-body">
						<h3>Congratulations!!</h3>
						<p>You got <?= $cashBk ?>cash back in your Frinza wallet against order id <?= $ordID ?>.</p>
						<p>Happy Shopping!</p>
