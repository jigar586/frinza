...
<!-- saved from url=(0110)http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/v2_templates/template_04.html -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <style type="text/css">
    ...
    */
    ...
    .bodyContent img, .bodyContentTwoColumn img {
      height:auto;
      max-width:498px;
    }
    ...
    */
    ...
    .brdBottomPadd-lg .bodyContent, .brdBottomPadd-lg .bodyContentTwoColumn { padding-bottom: 2.286em; }
    .brdBottomPadd { border-bottom: 1px solid #f0f0f0; }
    .brdBottomPadd .bodyContent, .brdBottomPadd .bodyContentTwoColumn { padding-bottom: 0em; }
    a.blue-btn {
      background: #5098ea;
			...
			<tbody><tr>
				<td valign="top" mc:edit="headerBrand" id="templateContainerHeader">
					...
					<p style="text-align:center;margin:0;padding:0;">
						<img src="https://www.frinza.com/assets/emaildata/Newsletter_files/cog-01.jpg" style="display:inline-block; max-width: 100%;">
					</p>
      ...
      <tr>
				<td align="center" valign="top">
					<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerImageFull" style="min-height:15px;">
						<tbody><tr>
              <td width="1">
                <img src="https://www.frinza.com/assets/emaildata/Newsletter_files/blank.png" style="width: 1px; display:block; margin:0; padding:0; border:0;">
              </td>
                ...
                <p style="text-align:center;margin:0;padding:0;float:right;">
      						<img src="https://www.frinza.com/assets/emaildata/Newsletter_files/bvw-01.jpg" style="display:block; margin:0; padding:0; border:0; max-width: 100%;">
      					</p>
							</td>
						</tr>
					</tbody></table>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle" class="brdBottomPadd-lg">
							<tbody><tr>
								<td valign="top" class="bodyContent" mc:edit="body_content">
									...
									<p>B2B research consistently shows that 30-50% of leads are not ready to buy when they first inquire about your business, but about three quarters of these leads will become sales ready within 12 to 18 months.</p>
                  <a class="blue-btn" href="http://blog.autopilothq.com/lead-nurturing-secrets/"><strong>Read now</strong></a>
								</td>
							</tr>
						</tbody></table>
						<!-- // END BODY -->
      ...
      <tr>
				<td align="center" valign="top">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle" class="brdBottomPadd">
							<tbody><tr>
								<td valign="top" class="bodyContentTwoColumn">
                        ...
                        <table class="column">
                          <tbody><tr>
                            <td class="text" mc:edit="body_content_col1">
                              <p><img src="https://www.frinza.com/assets/emaildata/Newsletter_files/bvw-02.jpg" style="display:block; max-width: 100%;"></p>
                              <h4><strong>Title of article goes here</strong></h4>
                              <h4>This is a brief teaser of the article that you're featuring.</h4>
                              <h4><a href="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/v2_templates/template_04.html#">Read now</a></h4>
                            </td>
                          </tr>
                        </tbody></table>
                        <!--[if (gte mso 9)|(IE)]>
                        ...
                        <table class="column">
                          <tbody><tr>
                            <td class="text" mc:edit="body_content_col2">
                              <p><img src="https://www.frinza.com/assets/emaildata/Newsletter_files/bvw-03.jpg" style="display:block; max-width: 100%;"></p>
                              <h4><strong>Title of article goes here</strong></h4>
                              <h4>This is a brief teaser of the article that you're featuring.</h4>
                              <h4><a href="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/v2_templates/template_04.html#">Read now</a></h4>
                            </td>
                        ...
                        <table class="column">
                          <tbody><tr>
                            <td class="text" mc:edit="body_content_col3">
                              <p><img src="https://www.frinza.com/assets/emaildata/Newsletter_files/bvw-04.jpg" style="display:block; max-width: 100%;"></p>
                              <h4><strong>Title of article goes here</strong></h4>
                              <h4>This is a brief teaser of the article that you're featuring.</h4>
                              <h4><a href="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/v2_templates/template_04.html#">Read now</a></h4>
                            </td>
                        ...
                        <table class="column">
                          <tbody><tr>
                            <td class="text" mc:edit="body_content_col4">
                              <p><img src="https://www.frinza.com/assets/emaildata/Newsletter_files/bvw-05.jpg" style="display:block; max-width: 100%;"></p>
                              <h4><strong>Title of article goes here</strong></h4>
                              <h4>This is a brief teaser of the article that you're featuring.</h4>
                              <h4><a href="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/v2_templates/template_04.html#">Read now</a></h4>
                            </td>
                        ...
                        <table class="column">
                          <tbody><tr>
                            <td class="text" mc:edit="body_content_col5">
                              <p><img src="https://www.frinza.com/assets/emaildata/Newsletter_files/bvw-06.jpg" style="display:block; max-width: 100%;"></p>
                              <h4><strong>Title of article goes here</strong></h4>
                              <h4>This is a brief teaser of the article that you're featuring.</h4>
                              <h4><a href="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/v2_templates/template_04.html#">Read now</a></h4>
                            </td>
                        ...
                        <table class="column">
                          <tbody><tr>
                            <td class="text" mc:edit="body_content_col6">
                              <p><img src="https://www.frinza.com/assets/emaildata/Newsletter_files/bvw-07.jpg" style="display:block; max-width: 100%;"></p>
                              <h4><strong>Title of article goes here</strong></h4>
                              <h4>This is a brief teaser of the article that you're featuring.</h4>
                              <h4><a href="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/v2_templates/template_04.html#">Read now</a></h4>
                            </td>
													...
													<tbody><tr>
														<td align="left" width="50" valign="top" mc:edit="footer_sigimage" style="margin:0;padding:0;">
															<p style="margin-bottom:10px" padding:0;display:block;="">
																<img src="https://www.frinza.com/assets/emaildata/Newsletter_files/img_profile.jpg" style="display:block; max-width: 100%;">
															</p>
														</td>
						...
						<tbody><tr>
							<td valign="top" width="100%" mc:edit="footer_unsubscribe">
								<p style="text-align:center;">
									<img src="https://www.frinza.com/assets/emaildata/Newsletter_files/cog-03.jpg" style="margin:0 auto 0 auto;display:inline-block; max-width: 100%;">
								</p>
								...
								<h6 style="text-align:center;margin-top: 7px;"><a href="http://c0185784a2b233b0db9b-d0e5e4adc266f8aacd2ff78abb166d77.r51.cf2.rackcdn.com/v2_templates/--unsubscribe--">unsubscribe</a></h6>
							</td>
						</tr>
					</tbody></table>
				</td>
...
<table cellpadding="0" cellspacing="0" border="0" class="hide" width="600">
  <tbody><tr>
    <td height="1" class="hide" style="min-width:600px; font-size:0px;line-height:0px;">
      <img height="1" width="600" src="https://www.frinza.com/assets/emaildata/Newsletter_files/blank.jpg" style="min-width: 600px; width: 600px; max-height: 1px; min-height: 1px; text-decoration: none; border: none; -ms-interpolation-mode: bicubic;">
    </td>
  </tr>
</tbody></table>
