                ...
                <form action="#" method="post" id="product_addtocart_form">
                  ...
                  <div class="product-img-box col-lg-5 col-sm-5 col-xs-12">
                    ...
                    <div class="product-image">
                      <div class="product-full"> <img id="product-zoom" src="http://via.placeholder.com/800x800" data-zoom-image="http://via.placeholder.com/800x800" alt="product-image"/> </div>
                      <div class="more-views">
                        <div class="slider-items-products">
                          <div id="gallery_01" class="product-flexslider hidden-buttons product-img-thumb">
                            <div class="slider-items slider-width-col4 block-content">
                              <div class="more-views-items"> <a href="#" data-image="http://via.placeholder.com/800x800" data-zoom-image="http://via.placeholder.com/800x800"> <img id="product-zoom"  src="http://via.placeholder.com/800x800" alt="product-image"/> </a></div>
                              <div class="more-views-items"> <a href="#" data-image="http://via.placeholder.com/800x800" data-zoom-image="http://via.placeholder.com/800x800"> <img id="product-zoom"  src="http://via.placeholder.com/800x800" alt="product-image"/> </a></div>
                              <div class="more-views-items"> <a href="#" data-image="http://via.placeholder.com/800x800" data-zoom-image="http://via.placeholder.com/800x800"> <img id="product-zoom"  src="http://via.placeholder.com/800x800" alt="product-image"/> </a></div>
                              <div class="more-views-items"> <a href="#" data-image="http://via.placeholder.com/800x800" data-zoom-image="http://via.placeholder.com/800x800"> <img id="product-zoom"  src="http://via.placeholder.com/800x800" alt="product-image"/> </a> </div>
                              <div class="more-views-items"> <a href="#" data-image="http://via.placeholder.com/800x800" data-zoom-image="http://via.placeholder.com/800x800"> <img id="product-zoom"  src="http://via.placeholder.com/800x800" alt="product-image" /> </a></div>
