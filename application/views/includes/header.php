                          ...
                          <div class="col-xs-6 hidden-xs">
                              <div class="toplinks">
                                  <div class="links">
                                      ...
                                      <?php }else{ ?> <div class="logout"><a href="<?= base_url('logout') ?>"><span class="hidden-xs">Logout</span></a> </div>
                                      <?php } ?>
                                  </div>
                              </div>
                          </div>
                      ...
                      <div class="row">
                          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 hidden-xs top-15margin">
                              <div class="search-box">
                                  <form action="<?= base_url('search') ?>" method="get" id="search_mini_form"
                                      name="Categories">
                                      <input type="text" placeholder="Search entire store here..." minlength='3'
                                          maxlength="70" name="term" id="search" required>
                          ...
                          <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 logo-block">
                              <!-- Header Logo -->
                              <div class="logo"> <a title="Frinza" href="<?= base_url() ?>"><img alt="Frinza"
                                          src="<?= FOLDER_ASSETS_TEMPLATEDATA ?>images/Frinza-logo-header.png"> </a>
                              </div>
                              <!-- End Header Logo -->
                          </div>
                          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 top-15margin">
                              <div class="top-cart-contain pull-right">
                                  <!-- Top Cart -->
                                  <div class="mini-cart">
                                      <div onclick='toggleCart()' class="basket dropdown-toggle"> <a
                                              href="javascript:void(0)"> <span
                                                  class="cart_count"><?= getCartCount() ?></span><span class="price">My
                                                  Cart / ₹<?= getCartValue() ?></span> </a> </div>
                                      <div>
                                          <div class="top-cart-content" style="display: none;">
													...
													?>
														<li class="item">
															<div class="item-inner"> <a class="product-image"
																	title="<?= $r['product_title'] ?>" href="#l"><img
																		alt="<?= $r['product_title'] ?>"
																...
																<div class="product-details">
																	...
																	<!--access--><strong><?= $r['qty'] ?></strong> x <span
																		class="price">₹<?= $r['price'] ?></span>
																	<p class="product-name"><a href="<?= base_url('').url_title($r['product_title'],'-',TRUE).'/p'.$r['product_id'] ?>"><?= $r['product_title'] ?></a>
																	</p>
																</div>
															</div>
														</li>
                                              ...
                                              <!--actions-->
                                              <div class="actions">
                                                  <!-- <button class="btn-checkout" title="Checkout" onclick="window.location.href = '<?= base_url('checkout') ?>'" type="button"><span>Checkout</span> </button> -->
