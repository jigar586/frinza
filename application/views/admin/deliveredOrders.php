      ...
      <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
          <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Orders</span> - Delivered Orders</h4>
...
<script type="text/javascript">
  $(document).ready(function(){
    var banurl = '<?= base_url('admin/deliveredorderstable') ?>';
    viewTable(banurl);
  });
  ...
  $(document).ready(function(){
    $('#orderFilter').on('submit',function(e){
      ...
      $.ajax({
        url: '<?= base_url('admin/deliveredorderstable') ?>',
        processData: false,
        contentType: false,
        type: 'post',
        data: formData,
