      ...
      <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
          <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Blogs</span> - View Blogs</h4>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    var caturl = '<?= base_url('admin/blogtable') ?>';
    viewTable(caturl);
  });
function updateBlog($id,$e)
  {
    var data = new FormData();
    data.append('blog_id',$id);
    data.append('is_live',$e);
    $.ajax({
      ...
      success: function(a){
        $('.myMsg').html(a);
        viewTable('<?= base_url('admin/blogtable') ?>');
      }
    });
  }
  function onBlog($id){
