      ...
      <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
          <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Website</span> - About Us</h4>
          ...
          <div class="col-xl-12">
            <div class="card">
              <div class="card-header header-elements-inline">
                <h6 class="card-title">Add about us content</h6>
              </div>
  ...
  <script type="text/javascript">
    $(document).ready(function()
    {
      ...
      $('#save').on('click',function(e){
        ...
        $.ajax({
          url: '<?= base_url('admin/site/aboutus') ?>',
          processData: false,
          contentType: false,
          type: 'post',
          data: formData,
          success: function(a){
            $('.myMsg').html(a);
            setTimeout(function(){$('.myMsg').empty()},2000);
          }
        })
      });
    })
