      ...
      <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
          <div class="page-title d-flex">
            <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Orders</span> - Accepted Orders</h4>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
          <div class="d-flex">
            <div class="breadcrumb">
              ...
              <span class="breadcrumb-item active">Accepted Orders</span>
            </div>
...
<script type="text/javascript">
  var banurl = '<?= base_url('admin/acceptedorderstable') ?>';
  ...
  $(document).ready(function(){
    $('#orderFilter').on('submit',function(e){
      ...
      $.ajax({
        url: '<?= base_url('admin/acceptedorderstable') ?>',
        processData: false,
        contentType: false,
        type: 'post',
        data: formData,
