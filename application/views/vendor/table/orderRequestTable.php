            ...
            <tbody>
              <?php if (count($orders)) {
                ...
                foreach ($orders as $ord) {
                 ...
                 ?>
              <tr <?php if($ord->last_bargain){ echo "class='text-danger'"; } ?>>
                <td><?= ++$i ?></td>
                ...
                <td class="text-center">
                      ...
                      <button type="button" onclick="getDetailForVendor(<?= $ord->assign_id.','.$ord->last_bargain ?>)" class="btn btn-outline-danger btn-sm rounded-round">Check Details</button>
